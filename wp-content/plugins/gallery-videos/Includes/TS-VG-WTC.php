...
if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Thumbnails Video'){ ?>
  ...
  <style type="text/css">
      ...
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09!='none'){ ?> border: 1px solid <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_10;?> !important;
      ...
      .TotalSoftGV_TV_LM<?php echo $Total_Soft_Gallery_Video;?> {
          ...
          font-size: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_03;?>px;
          font-family: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_04;?>;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09!='none'){ ?> border: 1px solid<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_10;?>;
      <?php } else { ?> border: none !important;
      <?php }?> cursor: pointer;
          display: block;
      ...
      #boxer {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_20=='true'){ ?> background: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_21;?>;
      <?php }?> border-radius: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22;?>px;
          box-shadow: 0 0 25px<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_23;?>;
      }

      #boxer .boxer-container {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_24=='true'){ ?> background: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_25;?>;
      <?php }?>
      }
      ...
      .boxer_<?php echo $Total_Soft_Gallery_Video;?> {
          opacity: 0;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'moveUp'){ ?> -webkit-transform: translateY(200px);
          -moz-transform: translateY(200px);
          transform: translateY(200px);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'scaleUp'){ ?> -webkit-transform: scale(0.6);
          -moz-transform: scale(0.6);
          transform: scale(0.6);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg);
          -moz-transform: rotateY(-180deg);
          transform: rotateY(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
       ...
       <img src="<?php echo plugins_url('../Images/Loading/loading' . $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_16 . '.gif',__FILE__); ?>">
			...
			<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
				<?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL==''){
					$TS_GV_TG_VSR=$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL;
				}
				else{
					$TS_GV_TG_VSR=$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL;
				} ?>
...
<?php }
  ...
  <style type="text/css">
      ...
      ul.pagination<?php echo $Total_Soft_Gallery_Video;?> li span {
          ...
          height: auto !important;
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_39!='none'){ ?> border: 1px solid<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_01;?>;
      <?php } else { ?> border: none !important;
      ...
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06=='true'){ ?> -webkit-box-shadow: 0px 0px <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07;?>px<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08;?>;
      ...
      <?php }?> cursor: pointer;
          ...
          overflow: hidden;
          opacity: 0;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'moveUp'){ ?> -webkit-transform: translateY(200px);
          -moz-transform: translateY(200px);
          transform: translateY(200px);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'scaleUp'){ ?> -webkit-transform: scale(0.6);
          -moz-transform: scale(0.6);
          transform: scale(0.6);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 50% 50% -300px;
          -moz-transform-origin: 50% 50% -300px;
          ...
          -moz-transform: rotateX(-180deg);
          transform: rotateX(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 0% 0%;
          -moz-transform-origin: 0% 0%;
          ...
          -moz-transform: rotateX(-80deg);
          transform: rotateX(-80deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg);
          -moz-transform: rotateY(-180deg);
          transform: rotateY(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: scale(0.4);
          -moz-transform: scale(0.4);
      ...
      .totalsoftview<?php echo $Total_Soft_Gallery_Video;?> p {
          line-height: 1 !important;
      }
      ...
      .popDescr<?php echo $Total_Soft_Gallery_Video;?>::-webkit-scrollbar {
          width: 0.5em;
      }
      ...
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }?>
      }
  ...
  <div class="TotalSoft_GV_CP_Popup TotalSoft_GV_CP_Popup<?php echo $Total_Soft_Gallery_Video; ?>">
    ...
    <div class="TotalSoft_GV_CP_Pop_Icons TotalSoft_GV_CP_Pop_Icons<?php echo $Total_Soft_Gallery_Video; ?>">
      <input type="text" style="display:none;" id="TotalSoft_GV_CP_VID_<?php echo $Total_Soft_Gallery_Video; ?>"> <input type="text" style="display:none;" id="TotalSoft_GV_CP_PoM_<?php echo $Total_Soft_Gallery_Video; ?>" value="<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_34; ?>">
      <div class="TotalSoft_GV_CP_Pop_Icons_1 TotalSoft_GV_CP_Pop_Icons_1<?php echo $Total_Soft_Gallery_Video; ?>">
        <i class="totalsoftleft <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_30; ?>" onclick="TotalSoft_GV_CP_Left<?php echo $Total_Soft_Gallery_Video; ?>('<?php echo $Total_Soft_Gallery_Video; ?>')"></i> <i class="totalsoftright <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_31; ?>" onclick="TotalSoft_GV_CP_Right<?php echo $Total_Soft_Gallery_Video; ?>('<?php echo $Total_Soft_Gallery_Video; ?>')"></i>
      </div>
  ...
  <script type="text/javascript">
    ...
    function TotalSoft_GV_CP_Close_Popup<?php echo $Total_Soft_Gallery_Video;?>() {
      ...
      if(TotalSoft_GV_CP_PoM=='') {
        ...
        setTimeout(function() {
          jQuery('.TotalSoft_GV_CP_Content<?php echo $Total_Soft_Gallery_Video;?>').animate({'height': '0%',}, 300);
        }, 800)
      }
      else if(TotalSoft_GV_CP_PoM=='mode01') {
        jQuery('.TotalSoft_GV_CP_Iframe<?php echo $Total_Soft_Gallery_Video;?> iframe').attr('src', '');
      ...
      jQuery.ajax({
        type: 'POST', url: object.ajaxurl, data: {
          ...
          if(TotalSoft_GV_CP_PoM=='') {
            ...
            setTimeout(function() {
              jQuery('.TotalSoft_GV_CP_Popup<?php echo $Total_Soft_Gallery_Video;?>').show()
            }, 1000);
            jQuery('.TotalSoft_GV_CP_Iframe<?php echo $Total_Soft_Gallery_Video;?>').css({'transform': 'translateX(-12000px)', '-ms-transform': 'translateX(-12000px)', '-o-transform': 'translateX(-12000px)', '-moz-transform': 'translateX(-12000px)', '-webkit-transform': 'translateX(-12000px)'});
            jQuery('.TotalSoft_GV_CP_TD<?php echo $Total_Soft_Gallery_Video;?> h2').css({'transform': 'translateX(12000px)', '-ms-transform': 'translateX(12000px)', '-o-transform': 'translateX(12000px)', '-moz-transform': 'translateX(12000px)', '-webkit-transform': 'translateX(12000px)'});
            jQuery('.TotalSoft_GV_CP_TD<?php echo $Total_Soft_Gallery_Video;?> p').css({'transform': 'translateX(12000px)', '-ms-transform': 'translateX(12000px)', '-o-transform': 'translateX(12000px)', '-moz-transform': 'translateX(12000px)', '-webkit-transform': 'translateX(12000px)'});
    ...
    jQuery(document).ready(function() {
      ...
      function resp<?php echo $Total_Soft_Gallery_Video;?>() {
        ...
        if(jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().width() <= 300) {
          ...
          jQuery('.totalsoftview<?php echo $Total_Soft_Gallery_Video;?>').parent().parent().parent().css({'padding-left': '0', 'padding-right': '10px'})
        }

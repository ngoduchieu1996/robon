...
if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Parallax Engine'){ ?>
  <script type="text/javascript">
    (function(t, e, i) {
      ...
      t.colorbox<?php echo $Total_Soft_Gallery_Video;?>|| (t(p), J=t.fn[Y]=t[Y]=function(e, i) {
        ...
        if(W.unbind("resize." + Z), x.css({top: -9e4, left: -9e4}), h=W.scrollTop(), a=W.scrollLeft(), _.get("fixed") ? (c.top-=h, c.left-=a, x.css({position: "fixed"})) : (l=h, d=a, x.css({position: "fixed"})), d+=_.get("right")!== !1 ? Math.max(W.width() - _.w - N - j - s(_.get("right"), "x"), 0) : _.get("left")!== !1 ? s(_.get("left"), "x") : Math.round(Math.max(W.width() - _.w - N - j, 0) / 2), l+=_.get("bottom")!== !1 ? Math.max(n() - _.h - A - D - s(_.get("bottom"), "y"), 0) : _.get("top")!== !1 ? s(_.get("top"), "y") : Math.round(Math.max(n() - _.h - A - D, 0) / 2), x.css({top: c.top, left: c.left, visibility: "visible"}), y[0].style.width=y[0].style.height="9999px", r={width: _.w + N + j, height: _.h + A + D, top: l, left: d}, e) {
          var g=0;
          t.each(r, function(t) {
      ...
      $.swipebox<?php echo $Total_Soft_Gallery_Video;?>=function(elem, options) {
        ...
        var ui={
          init: function(index) {
            ...
            return '<div class="swipebox<?php echo $Total_Soft_Gallery_Video;?>-video-container" style="max-width:' + plugin.settings.videomaxWidth + 'px"><div class="swipebox<?php echo $Total_Soft_Gallery_Video;?>-video">' + iframe + "</div></div>"
  ...
  <div class="TotSoft_GV_Container-parent<?php echo $Total_Soft_Gallery_Video; ?>" style="position: relative; width: 100%; float: left;">
    ...
    <div class="TotSoft_GV_Container TotSoft_GV_Container_<?php echo $Total_Soft_Gallery_Video; ?> myExMul" id="swipeboxVideo_Totsoft">
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
						<?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL==''){
							...
							if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29==1){
								...
								$TS_GV_PE_VSR=$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL;
							}
						} ?>
           ...
           <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" datah="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>"/>
             ...
             <div class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_26; ?> Ov_TotalSoft"></div>
							...
							<?php }else{ ?>
           <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>"/> <span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
											<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>
													<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1||$TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true'){ ?>
               <br/><i class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_16; ?> TotalSoft_PI"></i>
													<?php } ?>
             ...
             <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>"/> <span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
               ...
               <div class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_26; ?> Ov_TotalSoft"></div>
							...
							<?php }else{ ?>
								<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29==1){ ?>
             <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" style="display:none;" class="noshow1 TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>"/> <span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
												<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>
															<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1||$TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true'){ ?>
                 <br/><i class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_16; ?> TotalSoft_PI"></i>
															<?php } ?>
            ...
            <div class="TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video; ?>">
               ...
               <video controls poster="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>">
                 ...
                 <iframe src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL; ?>&autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3" frameborder="0" webkitAllowFullScreen></iframe>
														<?php }else{ ?>
                 <iframe src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL; ?>?autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3" frameborder="0" webkitAllowFullScreen></iframe> <?php } ?>
													<?php } ?>
            </div>
										<?php } ?>

...
if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Elastic Gallery'){ ?>
  ...
  <style type="text/css">
      ...
      .lg-toolbar<?php echo $Total_Soft_Gallery_Video;?> .lg-close<?php echo $Total_Soft_Gallery_Video;?>:after {
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?> {
          ...
          margin: 5px;
          overflow: hidden;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'moveUp'){ ?> -webkit-transform: translateY(200px);
          -moz-transform: translateY(200px);
          transform: translateY(200px);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'scaleUp'){ ?> -webkit-transform: scale(0.6);
          -moz-transform: scale(0.6);
          transform: scale(0.6);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg);
          -moz-transform: rotateY(-180deg);
          transform: rotateY(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff1 {
          top: -25%;
      }
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff2 {
          top: 0%;
      }
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff3 {
          top: 0%;
          left: 0%;
          width: 100%;
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff4 {
          top: -15%;
          left: -15%;
          width: 130%;
          height: 130% !important;
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff5 {
          width: 130%;
          height: 130% !important;
      }
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff6 {
          width: 130%;
          height: 130% !important;
          top: -30%;
      }
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff7 {
          width: 130%;
          height: 130% !important;
          left: -30%;
      }
      ...
      .fhovZoom<?php echo $Total_Soft_Gallery_Video;?>:hover .zEff8 {
          width: 130%;
          height: 130% !important;
          left: -30%;
          top: -30%;
      ...
      .pagination<?php echo $Total_Soft_Gallery_Video;?> ul li {
          display: inline-block;
      ...
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_15!='none'){ ?> border: 1px solid<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_16;?>;
      ...
      @media screen and (max-width: 820px) {
          ...
          .lg-actions<?php echo $Total_Soft_Gallery_Video;?> .lg-prev<?php echo $Total_Soft_Gallery_Video;?>, .lg-actions<?php echo $Total_Soft_Gallery_Video;?> .lg-next<?php echo $Total_Soft_Gallery_Video;?> {
              font-size: 15px;
          }
      ...
      .Tot_Vid_Gallery<?php echo $Total_Soft_Gallery_Video;?> {
          display: block;
          text-align: center;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }?>
      }
  ...
  <div class="video-gallery-parent<?php echo $Total_Soft_Gallery_Video; ?>" style="position: relative; width: 100%;     text-align: -webkit-center;text-align:center;">
    ...
    <div id="video-gallery" class='Tot_Vid_Gallery<?php echo $Total_Soft_Gallery_Video; ?>' style='text-align:center; display: -webkit-inline-box;margin: 0 auto;'>
         ...
         <div id="TotalSoft_GV_HLG_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class='fhovZoom<?php echo $Total_Soft_Gallery_Video; ?>' href="<?php echo $TS_GV_EG_PSRST; ?>" data-poster="<?php echo $TS_GV_EG_PSR; ?>" onclick='TotalsofthPIcon()'>
           <a href='#'> <img class='zEff <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08; ?>' style='max-width:none;' src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>"/>
             <div class='<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>' style='background:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_13; ?>;'>
										...
										</span> <i onclick='TotalsofthPIcon()' class='TotalsofthPIcon1 <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_19; ?>'></i>
  ...
  <script type="text/javascript">
   ...
   jQuery('.TotalsofthLIcon1<?php echo $Total_Soft_Gallery_Video;?>').one('click', function() {
     TotalsoftLink<?php echo $Total_Soft_Gallery_Video;?>();
   })
  </script>
  <script type="text/javascript">
    var y=true;
    ...
    (function($, window, document, undefined) {
      ...
      if(Totalsoft_Loop<?php echo $Total_Soft_Gallery_Video;?>=='true') {
        Totalsoft_Loop<?php echo $Total_Soft_Gallery_Video;?>=true;
      }
      else {
        Totalsoft_Loop<?php echo $Total_Soft_Gallery_Video;?>=false;
      }
      'use strict';
      var defaults={
        mode: 'lg-slide', cssEasing: 'ease', easing: 'linear', speed: Totalsoft_SlDuration<?php echo $Total_Soft_Gallery_Video;?>* 100, height: '100%', width: '100%', addClass: '', startClass: 'lg-start-zoom', backdropDuration: 150, hideBarsDelay: 6000, useLeft: false, closable: true, loop: Totalsoft_Loop<?php echo $Total_Soft_Gallery_Video;?>, escKey: true, keyPress: true, controls: true, slideEndAnimatoin: true, hideControlOnEnd: false, mousewheel: true, getCaptionFromTitleOrAlt: true, appendSubHtmlTo: '.lg-sub-html', subHtmlSelectorRelative: false, preload: 1, showAfterLoad: true, selector: '', selectWithin: '', nextHtml: '', prevHtml: '', index: false, iframeMaxWidth: '100%', download: true, counter: true, appendCounterTo: '.lg-toolbar<?php echo $Total_Soft_Gallery_Video;?>', swipeThreshold: 50, enableSwipe: true, enableDrag: true, dynamic: false, dynamicEl: [], galleryId: 1
      };
      ...
      Plugin.prototype.structure=function() {
        ...
        if(this.s.controls && this.$items.length > 1) {
          controls='<div class="lg-actions lg-actions<?php echo $Total_Soft_Gallery_Video;?>">' + '<i class="lg-prev lg-prev<?php echo $Total_Soft_Gallery_Video;?> ' + Totalsoft_SlIcLeftType<?php echo $Total_Soft_Gallery_Video;?>+ '">' + this.s.prevHtml + '</i>' + '<i class="lg-next lg-next<?php echo $Total_Soft_Gallery_Video;?> ' + Totalsoft_SlIcRightType<?php echo $Total_Soft_Gallery_Video;?>+ '">' + this.s.nextHtml + '</i>' + '</div>';
        }
        if(this.s.appendSubHtmlTo==='.lg-sub-html') {
          subHtmlCont='<div class="lg-sub-html"></div>';
        }
        template='<div class="lg-outer lg-outer<?php echo $Total_Soft_Gallery_Video;?> ' + this.s.addClass + ' ' + this.s.startClass + '">' + '<div class="lg" style="width:' + this.s.width + '; height:' + this.s.height + '">' + '<div class="lg-inner">' + list + '</div>' + '<div class="lg-toolbar lg-toolbar<?php echo $Total_Soft_Gallery_Video;?> group">' + '<i class="' + Totalsoft_SlDelIcType<?php echo $Total_Soft_Gallery_Video;?>+ ' lg-close lg-close<?php echo $Total_Soft_Gallery_Video;?> lg-iconn"></i>' + '</div>' + controls + subHtmlCont + '</div>' + '</div>';
      ...
      Plugin.prototype.slide=function(index, fromTouch, fromThumb) {
        ...
        if(!_this.lgBusy) {
          ...
          if(this.s.counter) {
            $('#lg-counter<?php echo $Total_Soft_Gallery_Video;?>-current').text(index + 1);
          }
        }
      };
      ...
      Plugin.prototype.arrow=function() {
        var _this=this;
        this.$outer.find('.lg-prev<?php echo $Total_Soft_Gallery_Video;?>').on('click.lg', function() {
          _this.goToPrevSlide();
        });
        this.$outer.find('.lg-next<?php echo $Total_Soft_Gallery_Video;?>').on('click.lg', function() {
          _this.goToNextSlide();
        });
      };
      Plugin.prototype.arrowDisable=function(index) {
        if(!this.s.loop && this.s.hideControlOnEnd) {
          if((index + 1) < this.$slide.length) {
            this.$outer.find('.lg-next<?php echo $Total_Soft_Gallery_Video;?>').removeAttr('disabled').removeClass('disabled');
          }
          else {
            this.$outer.find('.lg-next<?php echo $Total_Soft_Gallery_Video;?>').attr('disabled', 'disabled').addClass('disabled');
          }
          if(index > 0) {
            this.$outer.find('.lg-prev<?php echo $Total_Soft_Gallery_Video;?>').removeAttr('disabled').removeClass('disabled');
          }
          else {
            this.$outer.find('.lg-prev<?php echo $Total_Soft_Gallery_Video;?>').attr('disabled', 'disabled').addClass('disabled');
          }
        }
      };
      ...
      Plugin.prototype.closeGallery=function() {
        var _this=this;
        var mousedown=false;
        this.$outer.find('.lg-close<?php echo $Total_Soft_Gallery_Video;?>').on('click.lg', function() {
          _this.destroy();
        });
        if(_this.s.closable) {
      ...
      Plugin.prototype.destroy=function(d) {
        ...
        if(d) {
          ...
          $.removeData(_this.el, 'lightGallery<?php echo $Total_Soft_Gallery_Video;?>');
        }
        this.$el.off('.lg.tm');
        $.each($.fn.lightGallery<?php echo $Total_Soft_Gallery_Video;?>.modules, function(key) {
      ...
      $.fn.lightGallery<?php echo $Total_Soft_Gallery_Video;?> =function(options) {
        return this.each(function() {
          if(!$.data(this, 'lightGallery<?php echo $Total_Soft_Gallery_Video;?>')) {
            ...
            try {
              $(this).data('lightGallery<?php echo $Total_Soft_Gallery_Video;?>').init();
            } catch(err) {
              console.error('lightGallery<?php echo $Total_Soft_Gallery_Video;?> has not initiated properly');
            }
          }
        });
      };
  ...
  <script type="text/javascript">
    (function($, window, document, undefined) {
      ...
      'use strict';
      var defaults={
        autoplay: Totalsoft_Autoplay, pause: 5000, progressBar: true, fourceAutoplay: false, autoplayControls: true, appendAutoplayControlsTo: '.lg-toolbar<?php echo $Total_Soft_Gallery_Video;?>'
      };
...
<?php }else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Fancy Gallery'){ ?>
  ...
  <style>
      ...
      .pagination<?php echo $Total_Soft_Gallery_Video;?>:before, .pagination<?php echo $Total_Soft_Gallery_Video;?>:after {
          background: none;
      }
      ...
      ul.pagination<?php echo $Total_Soft_Gallery_Video;?> li span {
          ...
          height: auto !important;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_23!='none'){ ?> border: 1px solid <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_24;?> !important;
      <?php }else{ ?> border: none !important;
      <?php } ?> display: block;
      }
      ...
      #html5-elem-data-box::-webkit-scrollbar {
          width: 9px;
      }

      /* Track */
      #html5-elem-data-box::-webkit-scrollbar-track {
          background: none;
      }
      ...
      .og-expander::-webkit-scrollbar-thumb:hover {
          background: #cecece;
      }

      #da-thumbs li {
          border-bottom: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_03;?>px solid <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_04;?> !important;
      }
      ...
      @media screen and (max-width: 1025px) {
          ...
          #html5-elem-box {
              top: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_04+10;?>px;
          }
  ...
  <div class="da-thumbs-parent<?php echo $Total_Soft_Gallery_Video; ?>" style="position: relative; width: 100%; float: left;">
    ...
    <ul id="da-thumbs" class="da-thumbs Total_Soft_GV_Fancy_<?php echo $Total_Soft_Gallery_Video; ?>" style='padding:0px;'>
         ...
         <a href="<?php echo $TS_GV_FG_VSR; ?>" class="html5lightbox" data-width="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_33; ?>" data-height="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_34; ?>" data-group="mygroup<?php echo $Total_Soft_GalleryV_Man[0]->id; ?>" data-thumbnail="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>" title="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT; ?>"
										...
										?>
          data-description='<?php echo $convert; ?>'> <img style='margin:0px;max-width:none;width:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01; ?>px;height:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_02; ?>px;' src="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL; ?>">
           <div style='background:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29; ?>'>
							...
							<?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink!=''){ ?>
           <a class='Totalsoft_VL' href='<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink ?>' <?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VONT=='true'){
												echo 'target="_blank"';
											} ?>>
